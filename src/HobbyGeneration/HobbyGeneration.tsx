...
export const HobbyGeneration: React.FC = () => {
  ...
  const disabled= [(loadingStatusActivity !== LoadingStatus.SUCCESS) || (loadingStatusUser !== LoadingStatus.SUCCESS)].every(Boolean)
  ...
  return (
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.btn}>
        ...
        <div>
          <Button variant= "outlined"  color='success' disabled={disabled} onClick={saveUserAndGenerateData} >Access</Button>
        </div>
      </div>
      </div>)}
      { statisticShow ?  
