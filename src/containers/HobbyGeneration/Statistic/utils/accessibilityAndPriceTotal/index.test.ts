...
import { accessibilityAndPriceTotal } from '.';

describe('accessibilityAndPriceTotal', () => {
  test('should return accessibilityTotal and priseTotal base case', () => {
    ...
    expect(accessibilityAndPriceTotal(users)).toEqual(result);
  });
  test('should return result for accessibility = undefined & price = undefined', () => {
    const users: UserStatistic[] = [
